        ...
        <RootLayout>
            <div className="card">
                ...
                <div className="d-flex justify-content-center">
                    {isPreview && <Link className="btn btn-primary mx-3 btn-sm" to={`/edit/${id}`} >Edit</Link>}
                    {isPreview && <button onClick={handleDelete} className="btn btn-primary mx-3 btn-sm" >Delete</button>}
                </div>
            </div>
        </RootLayout>
    )
